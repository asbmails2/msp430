...
void adcConfig(void){
    ...
    ADC12MCTL0 = ADC12SREF_0 |      //3.3V a 0V
                 ADC12INCH_0;       //P6.0
    ADC12MCTL0 = ADC12SREF_1 |      //1,5V a 0V
                 ADC12INCH_1;       //P6.1
...
void dmaConfig(void){
    ...
    DMA0DA = &lumSensor; //Endereço destino
    ...
    DMA2CTL = DMAEN | DMADT_4; //Habilita DMA1 no modo Repetido
    DMA2SA = (__SFR_FARPTR)0x0724; //Pega o dado da MEM2
    DMA2DA = &umiSensor; //Endereço destino
    DMA2SZ = 1; //Apenas 1 transferência
}
